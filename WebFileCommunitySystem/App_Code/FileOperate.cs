...
namespace DotNet.Utilities
{
    public class FileOperate
    {
        ...
        *****************************************/
        ...
        /// <param name="Path">文件路径</param>
        /// <param name="Strings">文件内容</param>
        public static void WriteFile(string Path, string Strings,bool isapand)
        {
            ...
            System.IO.StreamWriter f2 = new System.IO.StreamWriter(Path, isapand, System.Text.Encoding.UTF8);
            f2.WriteLine(Strings);
            f2.Close();
            f2.Dispose();
